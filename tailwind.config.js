  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'nexzen-gradient': 'linear-gradient(135deg, #00d2ff 0%, #3a7bd5 50%, #00ffff 100%)',
        'nexzen-gradient-dark': 'linear-gradient(135deg, rgba(0,210,255,0.15) 0%, rgba(58,123,213,0.15) 50%, rgba(0,255,255,0.15) 100%)',
      ...
      keyframes: {
        ...
        borderGlow: {
          '0%, 100%': { borderColor: 'rgba(0,210,255,0.3)' },
          '50%': { borderColor: 'rgba(58,123,213,0.8)' },
        },
        shimmer: {
      ...
      boxShadow: {
        ...
        'glow-violet': '0 0 20px rgba(58,123,213,0.4)',
        'card': '0 4px 24px rgba(0,0,0,0.4)',
        'card-hover': '0 8px 40px rgba(0,0,0,0.6), 0 0 20px rgba(0,210,255,0.15)',
