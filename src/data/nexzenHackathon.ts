...
export const NEXZEN_THEMES = [
  ...
  },
  {
    id: 'smart-cities',
    icon: '🏙️',
    title: 'Smart India / Smart Cities',
    shortTitle: 'Smart Cities',
    description: 'Innovate for urban infrastructure, intelligent traffic management, smart civic governance, and connected sustainable cities.',
  ...
  },
  {
    ...
    description: 'Create solutions for digital safety — threat detection, secure authentication, fraud prevention, and privacy vulnerability analysis.',
  ...
  },
  {
    ...
    shortTitle: 'FinTech',
    description: 'Innovate in digital payments, banking technology, financial inclusion, decentralized finance, and transaction security.',
  ...
  },
  {
    ...
    description: 'Solutions for healthcare accessibility, telemedicine, mental wellness, patient data management, and assistive health technologies.',
  ...
  },
  {
    ...
    description: 'Address climate change through carbon tracking, clean energy optimization, smart waste management, and sustainable technology.',
...
export const NEXZEN_HACKATHON: Hackathon = {
  ...
  domains: ['AI/ML', 'Cybersecurity', 'Data Science', 'Other'] as Domain[],
